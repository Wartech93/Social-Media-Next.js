    ...
    return (
        <div className='h-24 flex items-center justify-between'>
            ...
            <div className='md:hidden lg:block w-[20%]'>
                <Link href="/" className='font-bold text-xl text-red-600 shadow-md'>
                    War Games Central
                </Link>
            </div>
            {/* Center */}
            <div className='hidden md:flex w-[50%] gap-2 text-small items-center justify-between'>
                {/* LINKS */}
                ...
                <ClerkLoaded>
                    <SignedIn>
                        <div className='cursor-pointer'>
                            <Image src="/people.png" alt="People" width={24} height={24} className="w-6 h-6" />
                        </div>
                        <div className='cursor-pointer'>
